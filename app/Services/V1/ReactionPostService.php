...
use App\Interfaces\v1\ReactionPostInterface;
use App\Models\Validations\ReactionPostValidation;
...
class ReactionPostService {
    ...
    public function __construct(ReactionPostInterface $interface, ReactionPostValidation $validation) {
