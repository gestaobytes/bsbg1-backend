...
use App\Models\Validations\PostValidation;
...
class PostService
{
    ...
    public function __construct(PostInterface $interface, PostValidation $validation)
    {
    ...
    {
        try {
            $interface = $this->interface->image($id, $request);
            return response()->json($interface, Response::HTTP_OK);
        } catch (QueryException $e) {
            return response()->json(['msg' => 'Erro de conexão com o banco'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
