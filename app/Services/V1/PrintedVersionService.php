...
use App\Models\Validations\PrintedVersionValidation;
...
class PrintedVersionService {

    private $interface;
    private $validation;

    public function __construct(PrintedVersionInterface $interface, PrintedVersionValidation $validation) {
