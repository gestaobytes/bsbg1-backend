...
use App\Models\Validations\RoleValidation;
...
class RoleService
{
    ...
    public function __construct(RoleInterface $interface, RoleValidation $validation)
    {
    ...
    {
        try {
            $interface = $this->interface->roleUser($request);
            return response()->json($interface, Response::HTTP_CREATED);
        } catch (QueryException $e) {
            return response()->json(['msg' => 'Erro de conexão com o banco'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    public function roleUserDelete($id)
    {
        try {
            $interface = $this->interface->roleUserDelete($id);
            return response()->json(null, Response::HTTP_OK);
        } catch (QueryException $e) {
            return response()->json(['msg' => 'Erro de conexão com o banco'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
