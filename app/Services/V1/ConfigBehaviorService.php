...
use App\Models\Validations\ConfigBehaviorValidation;
...
class ConfigBehaviorService {

    private $interface;
    private $validation;

    public function __construct(ConfigBehaviorInterface $interface, ConfigBehaviorValidation $validation) {
