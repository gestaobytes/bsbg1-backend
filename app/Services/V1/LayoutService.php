...
use App\Interfaces\v1\LayoutInterface;
use App\Models\Validations\LayoutValidation;
...
class LayoutService {
    ...
    public function __construct(LayoutInterface $interface, LayoutValidation $validation) {
