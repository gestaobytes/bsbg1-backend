...
use App\Interfaces\v1\CompanyInterface;
use App\Models\Validations\CompanyValidation;
...
class CompanyService {
    ...
    public function __construct(CompanyInterface $interface, CompanyValidation $validation) {
