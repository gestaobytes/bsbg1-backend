...
use App\Models\Validations\ColumnerValidation;
...
class ColumnerService {

    private $interface;
    private $validation;

    public function __construct(ColumnerInterface $interface, ColumnerValidation $validation) {
