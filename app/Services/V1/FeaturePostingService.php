...
use App\Models\Validations\FeaturePostingValidation;
...
class FeaturePostingService {

    private $interface;
    private $validation;

    public function __construct(FeaturePostingInterface $interface, FeaturePostingValidation $validation) {
