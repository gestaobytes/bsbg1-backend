...
use App\Models\Validations\PermissionValidation;
...
class PermissionService
{
    ...
    public function __construct(PermissionInterface $interface, PermissionValidation $validation)
    {
    ...
    {
        try {
            $interface = $this->interface->permissionRole($request);
            return response()->json($interface, Response::HTTP_CREATED);
        } catch (QueryException $e) {
            return response()->json(['msg' => 'Erro de conexão com o banco'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    {
        try {
            $interface = $this->interface->permissionRoleDelete($id);
            return response()->json(null, Response::HTTP_OK);
        } catch (QueryException $e) {
            return response()->json(['msg' => 'Erro de conexão com o banco'], Response::HTTP_INTERNAL_SERVER_ERROR);
        }
