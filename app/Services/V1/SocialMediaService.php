...
use App\Interfaces\v1\SocialMediaInterface;
use App\Models\Validations\SocialMediaValidation;
...
class SocialMediaService {
    ...
    public function __construct(SocialMediaInterface $interface, SocialMediaValidation $validation) {
