...
use App\Interfaces\v1\PositionInterface;
use App\Models\Validations\PositionValidation;
...
class PositionService {
    ...
    public function __construct(PositionInterface $interface, PositionValidation $validation) {
