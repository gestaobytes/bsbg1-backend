...
use App\Models\Validations\PositionBannerValidation;
...
class PositionBannerService {

    private $interface;
    private $validation;

    public function __construct(PositionBannerInterface $interface, PositionBannerValidation $validation) {
