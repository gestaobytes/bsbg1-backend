...
use App\Interfaces\v1\EventInterface;
use App\Models\Validations\EventValidation;
...
class EventService {
    ...
    public function __construct(EventInterface $interface, EventValidation $validation) {
