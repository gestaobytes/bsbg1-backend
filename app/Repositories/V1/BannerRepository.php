...
use App\Interfaces\v1\BannerInterface;
use Illuminate\Http\Request;

class BannerRepository implements BannerInterface {
    private $model, $request;

    public function __construct(Banner $model, Request $request) {
        $this->model = $model;
    ...
    public function index()
    {
        ...
        $sortField = isset($_GET['sort']) ? $_GET['sort'] : '-id,name,banners.order';
        $fieldsToSelect = isset($_GET['fields']) ? $_GET['fields'] : 'id,name,order,end';
