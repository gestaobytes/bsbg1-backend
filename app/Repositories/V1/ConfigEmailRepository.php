...
use App\Interfaces\v1\ConfigEmailInterface;
use Illuminate\Http\Request;

class ConfigEmailRepository implements ConfigEmailInterface {
    private $model, $request;

    public function __construct(ConfigEmail $model, Request $request) {
        $this->model = $model;
