...
use App\Interfaces\v1\SocialColumnInterface;
use Illuminate\Http\Request;

class SocialColumnRepository implements SocialColumnInterface {
    private $model, $request;

    public function __construct(SocialColumn $model, Request $request) {
        $this->model = $model;
